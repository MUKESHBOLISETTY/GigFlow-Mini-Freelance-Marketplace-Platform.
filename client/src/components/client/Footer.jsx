...
const Footer = () => {
    return (
        <nav className="fixed bottom-0 left-0 right-0 bg-white/90 dark:bg-[#1a2632]/90 backdrop-blur-md border-t border-slate-200 dark:border-slate-800 pb-6 pt-2 z-50">
...
const NavItem = ({ icon, label, active = false }) => (
    <a className={`flex flex-col items-center gap-1 ${active ? 'text-[#137fec]' : 'text-slate-400 dark:text-slate-500'}`} href="#">
        {icon}
